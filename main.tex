...
\exercise[Rec--2.1]
Optionally, you can fully customize the numbering of each exercise \textellipsis

\setcounter{exercise}{7}
\exercise*
\textellipsis{} or skip a few, using the \verb|\setcounter{exercise}{x}| command.
